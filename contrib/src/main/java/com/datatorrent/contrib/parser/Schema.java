...
public class Schema
{
   ...
   */
  protected static final String TRUE_VALUE = "trueValue";
  /**
   * JSON key string for false value constraint
   */
  protected static final String FALSE_VALUE = "falseValue";
  /**
   ...
   * Default date format
   */
  protected final String DEFAULT_DATE_FORMAT = "dd/mm/yy";
  /**
  ...
  /**
   * Get the default false value
   * @return default false value
   */
  public static String getDefaultFalseValue()
  {
  ...
  /**
   * Get the default true value
   * @return default true value
   */
  public static String getDefaultTrueValue()
  {
